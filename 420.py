...
bannerID = f"""{green}  [ creater : ＳＨＡＨＡＲＩＡＲ ＺＡＭＡＮ] [ Version : {green}0.0.1{blue} 
...
python Random.py""")
		...
		print(f"          {blue}Installing Tool Please Wait{white}")
		print("----------------------------------------------")
		cmd("""git clone https://github.com/shahariar001M/Dragon-Clone.git
cd Dragon-Clone
